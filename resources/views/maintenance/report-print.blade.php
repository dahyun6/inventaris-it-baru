...
<div class="report-page">
    <div class="d-flex justify-content-between align-items-start border-bottom pb-3 mb-3">
        <div class="d-flex align-items-center gap-3">
            ...
            @endif
            <div>
                <h4 class="fw-bold text-dark mb-0" style="font-size: 1.25rem;">PANDORA IT OPERATIONS</h4>
                <div class="fw-semibold text-muted small">IT Dept. PT. SCG Barito Logistics</div>
                <div class="text-secondary small mt-1">{{ __('Laporan Rekapitulasi Servis & Maintenance Perangkat IT') }}</div>
            </div>
        </div>
